...
//go:generate ./goifyschema Buyer        https://protocol.licensezero.com/1.0.0-pre/buyer.json
...
//go:generate ./goifyschema ID           https://protocol.licensezero.com/1.0.0-pre/id.json
...
//go:generate ./goifyschema Name         https://protocol.licensezero.com/1.0.0-pre/name.json
//go:generate ./goifyschema Offer        https://protocol.licensezero.com/1.0.0-pre/offer.json
//go:generate ./goifyschema Order        https://protocol.licensezero.com/1.0.0-pre/order.json
//go:generate ./goifyschema Price        https://protocol.licensezero.com/1.0.0-pre/price.json
//go:generate ./goifyschema PrivateKey   https://protocol.licensezero.com/1.0.0-pre/private-key.json
//go:generate ./goifyschema PublicKey    https://protocol.licensezero.com/1.0.0-pre/public-key.json
...
//go:generate ./goifyschema Seller       https://protocol.licensezero.com/1.0.0-pre/seller.json
